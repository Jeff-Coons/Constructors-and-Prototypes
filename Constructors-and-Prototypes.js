...
function Dog(pero) {
  ...
  this.status = 'normal';
  this.color = pero.color;
  this.hungry = pero.hungry === undefined ? true : false;
}
...
function Human(persona) {
  ...
  this.cool = persona.cool === undefined ? false : true;
}

Human.prototype.pet = function(pero) {
  pero.status = 'happy';
};

Human.prototype.feed = function(eat) {
  eat.hungry = false;
}
